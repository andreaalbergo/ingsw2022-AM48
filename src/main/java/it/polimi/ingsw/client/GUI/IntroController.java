...
public class IntroController {
    ...
    public void switchToStartingPanel(ActionEvent event) throws IOException {
        root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Fxml_files/StartingPanel.fxml")));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    ...
    public void switchToSettingPage(ActionEvent event) throws IOException {
        ...
        if(!ipValid || !portValid || isInteger(username) || username.isEmpty()){
            ...
            if(result) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Fxml_files/SettingPage.fxml"));
                root = loader.load();
                ControllerSettingPage controllerSettingPage = loader.getController();
