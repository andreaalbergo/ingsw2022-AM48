...
public class ControllerSetUpGame {
    ...
    public void switchToLoadingPage(ActionEvent event) throws IOException {
        ...
        if (chosenWizard == null || numberOfPlayers < 2 || numberOfPlayers > 3) {
            ...
            if (result) {
                ...
                //MultiplayerServer.setNumber_of_players(Integer.parseInt(numberOfPlayers));
                //BoardHandler.setExpertMode(expertMode);

                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Fxml_files/LoadingPage.fxml"));
                root = loader.load();
