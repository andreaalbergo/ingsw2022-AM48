...
public class Old_BoardManager {
    ...
    private ArrayList<Old_Island> islands;
    ...
    public Old_BoardManager() {
        ...
        for(int i = 0; i < Board.getNumberOfPlayers(); i++){
             players.add(new Player(currentPlayer.getNickname(), i,true, Wizard.WIZARD1, Board.getNumberOfPlayers(), TowersColor.WHITE, Board.isExpertMode()));
...
/*
    ...
    private void checkToMergeIslands(Old_Island island) {
    ...
    //called when? BARB: PUT IT IN CLASS OBSERVER FOR "CONTROL", NOT BOARDMANAGER
